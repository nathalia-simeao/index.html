...
<head>
    ...
    <title>Barra - Aço Ressulfurado</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha2/dist/css/bootstrap.min.css" 
    rel="stylesheet"
    integrity="sha384-aFq/bzH65dt+w6FI2ooMVUpc+21e0SRygnTpmBvdBgSdnuTN7QbdgL+OapgHtvPp" 
    crossorigin="anonymous">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css">    <link rel="shortcut icon" href="assets/favicon.png" type="torcisão-icon">
...
<header class="container">
    <nav class="navbar-expand-lg navbar bg-body-tertiary fixed-top">
      <div class="container-fluidnav">        <a class="container__navbar-imagem" href="index.html"><img src="assets/lgcabecalhoescura220.png" alt="Logo da Torcisão Trefilados"></a>
...
<main>
    <div class="container product-page-header pt-4 pb-1 text-center">
        <h1 class="product-main-title fw-bold mb-4">
            Barras - Aço Ressulfurado 
        </h1>
        <div id="carousel-barraacoressulfurado" class="carousel slide product-carousel mb-3" data-bs-ride="carousel" data-bs-interval="3000">
            <div class="carousel-indicators">
                <button type="button" data-bs-target="#carousel-barraacoressulfurado" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                <button type="button" data-bs-target="#carousel-barraacoressulfurado" data-bs-slide-to="1" aria-label="Slide 2"></button>
                <button type="button" data-bs-target="#carousel-barraacoressulfurado" data-bs-slide-to="2" aria-label="Slide 3"></button>
                <button type="button" data-bs-target="#carousel-barraacoressulfurado" data-bs-slide-to="3" aria-label="Slide 4"></button>
            </div>
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="assets/barra4.jpg" class="d-block w-100" alt="Aço Ressulfurado - Imagem 1">
                </div>
                <div class="carousel-item">
                    <img src="https://torcisao.com.br/wp-content/uploads/2025/12/barra3.jpg" class="d-block w-100" alt="Aço Ressulfurado - Imagem 2">
                </div>
                <div class="carousel-item">
                    <img src="https://torcisao.com.br/wp-content/uploads/2025/12/barra2-2.webp" class="d-block w-100" alt="Aço Ressulfurado - Imagem 3">
                </div>
                <div class="carousel-item">
                    <img src="https://torcisao.com.br/wp-content/uploads/2025/12/barra1-2-scaled.jpg" class="d-block w-100" alt="Aço Ressulfurado - Imagem 4">
                </div>
            </div>
            <button class="carousel-control-prev" type="button" data-bs-target="#carousel-barraacoressulfurado" data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Anterior</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#carousel-barraacoressulfurado" data-bs-slide="next">
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6 col-lg-3 mb-4">
            <div class="card h-100 p-3 p-md-4 destaque-card-barras">
                ...
                <p class="card-text small">
                    Arame de aço de alto desempenho é o padrão da indústria, resultado do processo de trefilação que aprimora suas propriedades mecânicas. Ele se destaca pela sua uniformidade dimensional e pela elevada resistência à tração, mantendo um excelente equilíbrio entre tenacidade e dureza. É a escolha essencial para inúmeras aplicações que requerem alta performance estrutural e confiabilidade, oferecendo o equilíbrio ideal entre resistência mecânica superior e precisão na aplicação.
                </p>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6 col-lg-3 mb-4">
            <div class="card h-100 p-3 p-md-4 destaque-card-barras">
                ...
                <p class="card-text small">
                    <strong>Sua aplicação é vasta, abrangendo:</strong> aramados, displays aramados, carrinho de supermercado, gradil, utilidades domésticas, correntes, linha branca, esteiras e outros.
                </p>
            </div>
        </div>
            ...
            <div class="card h-100 p-3 p-md-4 destaque-card-barras">
                ...
                <p class="card-text small">
                    <ul>
                        ...
                        <li><strong>Comprimento</strong>: Rolos ou spiders;</li>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 mb-5 mb-md-0">
                        ...
                        <p class="d-flex flex-column mb-4">
                            <a class="contato-link d-flex align-items-center" href="mailto:vendas@torcaisao.com.br">
                                <img src="assets/email.png" alt="Email" class="footer-icon me-2" style="width: 20px;"> 
                                vendas@torcaisao.com.br
                            </a>
