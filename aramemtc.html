...
<head>
    ...
    <title>Arames - Médio Teor de Carbono</title>
...
<main>
    <div class="container product-page-header pt-4 pb-1 text-center">
        <h1 class="product-main-title fw-bold mb-4">
            Arames - Médio Teor de Carbono - 1035 a 1050
        </h1>
        <div id="carousel-aramemtc" class="carousel slide product-carousel mb-3" data-bs-ride="carousel" data-bs-interval="3000">
            <div class="carousel-indicators">
                <button type="button" data-bs-target="#carousel-aramemtc" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                <button type="button" data-bs-target="#carousel-aramemtc" data-bs-slide-to="1" aria-label="Slide 2"></button>
                <button type="button" data-bs-target="#carousel-aramemtc" data-bs-slide-to="2" aria-label="Slide 3"></button>
                <button type="button" data-bs-target="#carousel-aramemtc" data-bs-slide-to="3" aria-label="Slide 4"></button>
            </div>
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img src="assets/arame3.jpg" class="d-block w-100" alt="Arames MTC - Imagem 3">
                </div>
                <div class="carousel-item">
                    <img src="assets/arame4.jpg" class="d-block w-100" alt="Arames MTC - Imagem 4">
                </div>
            </div>
            <button class="carousel-control-prev" type="button" data-bs-target="#carousel-aramemtc" data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Anterior</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#carousel-aramemtc" data-bs-slide="next">
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6 col-lg-3 mb-4">
            <div class="card h-100 p-3 p-md-4 destaque-card-barras">
                ...
                <p class="card-text small">
                    <strong>Sua aplicação é vasta, abrangendo:</strong> Telas, Cabos, Molas, Componentes para Veículos, Pregos e outros.
                </p>
            </div>
        </div>
