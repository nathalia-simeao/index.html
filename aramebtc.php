...
<head>
    ...
    <title>Arames - Baixo Teor de Carbono</title>
    ...
    <header class="container">
        <nav class="navbar-expand-lg navbar bg-body-tertiary fixed-top">
            <div class="container-fluidnav">
                <a class="container__navbar-imagem" href="index.html"><img src="assets/lgcabecalhoescura220.png"
                        alt="Logo da Torcisão Trefilados"></a>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="offcanvasNavbarLabel"><img src="assets/lgcabecalhoescura220.png"
                                alt="Logo da Torcisão Trefilados"></h5>
                            ...
                            <li class="nav-item dropdown has-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item dropend has-submenu-2">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="barrabtc.html">BTC -
                                                    Baixo Teor de Carbono</a></li>
                                            <li><a class="dropdown-item" href="barramtc.html">MTC -
                                                    Médio Teor de Carbono</a></li>
                                                    <li><a class="dropdown-item" href="barraatc.html">ATC - Alto Teor de Carbono</a></li>
                                                <li><a class="dropdown-item"
                                                    href="barraacoressulfurado.html">Aço
                                                    Ressulfurado</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="nav-item dropend has-submenu-2">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="aramebtc.html">BTC -
                                                    Baixo Teor de Carbono</a></li>
                                            <li><a class="dropdown-item" href="aramemtc.html">MTC -
                                                    Médio Teor de Carbono</a></li>
    ...
    <main>
        <div class="container product-page-header pt-4 pb-1 text-center">
            <h1 class="product-main-title fw-bold mb-4">
                Arames - Baixo Teor de Carbono - 1004 a 1020
            </h1>
                <div id="carousel-aramebtc" class="carousel slide product-carousel mb-3" data-bs-ride="carousel" data-bs-interval="3000">
                    <div class="carousel-indicators">
                        <button type="button" data-bs-target="#carousel-aramebtc" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                        <button type="button" data-bs-target="#carousel-aramebtc" data-bs-slide-to="1" aria-label="Slide 2"></button>
                        <button type="button" data-bs-target="#carousel-aramebtc" data-bs-slide-to="2" aria-label="Slide 3"></button>
                        <button type="button" data-bs-target="#carousel-aramebtc" data-bs-slide-to="3" aria-label="Slide 4"></button>
                    </div>
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="assets/arame4.jpg" class="d-block w-100" alt="Arames - Imagem 1">
                        </div>
                        <div class="carousel-item">
                            <img src="assets/arame3.jpg" class="d-block w-100" alt="Arames - Imagem 2">
                        </div>
                        <div class="carousel-item">
                            <img src="assets/arame2.jpg" class="d-block w-100" alt="Arames - Imagem 3">
                        </div>
                        <div class="carousel-item">
                            <img src="https://torcisao.com.br/wp-content/uploads/2025/12/arame1.jpg" class="d-block w-100" alt="Arames - Imagem 4">
                        </div>
                    </div>
                    <button class="carousel-control-prev" type="button" data-bs-target="#carousel-aramebtc" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Anterior</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carousel-aramebtc" data-bs-slide="next">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-3 mb-4">
                    <div class="card h-100 p-3 p-md-4 destaque-card-barras">
                        ...
                        <p class="card-text small">
                            O arame de aço de alto desempenho é obtido através do processo de trefilação, que eleva suas características mecânicas. Se difere pela uniformidade dimensional e na melhora das propriedades mecânicas (limite de resistência, escoamento e dureza). Este material é fundamental em aplicações que exijam alta performance estrutural e confiabilidade, proporcionando um equilíbrio ideal entre limite de resistência, plasticidade e dureza.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 mb-4">
                    <div class="card h-100 p-3 p-md-4 destaque-card-barras">
                        ...
                        <p class="card-text small">
                            <strong>Sua aplicação é vasta, abrangendo:</strong> Displays Aramados, Carrinho de Supermercado, Gradil, Utilidades Domésticas, Linha Branca, Esteiras, Cesto Aramado, Rack Metálico e outros.</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 mb-4">
                    <div class="card h-100 p-3 p-md-4 destaque-card-barras">
                        ...
                        <ul>
                            ...
                            <li><strong>Acondicionamento</strong>: Rolos ou spiders;</li>
                            <li><strong>Perfil</strong>: Redondo.</li>
                            <li><strong>Acabamento</strong>: Trefilado.</li>
                        </ul>
                        </p>
                    </div>
                </div>
            ...
            <div class="container px-3">
                <div class="row text-center text-white justify-content-center align-items-center">
                    ...
                    <div class="col-12 col-md-4 col-lg-3 mb-4">
                        <img src="assets/certificado.png" alt="Controle de Qualidade" class="diferencial-img mb-3"
                            style="width: 50px;">
                        <p>Controle rigoroso de qualidade<br> em todos os produtos.</p>
                    </div>

                    <div class="col-12 col-md-4 col-lg-3 mb-4">
                        <img src="assets/suporte.png" alt="Suporte direto da fábrica" class="diferencial-img mb-3"
                            style="width: 50px;">
                        <p>Suporte direto da fábrica para<br> qualquer dúvida ou necessidade.</p>
                    </div>

                    <div class="col-12 col-md-4 col-lg-3 mb-4">
                        <img src="assets/frete.png" alt="Frete em toda Grande São Paulo" class="diferencial-img mb-3"
                            style="width: 50px;">
                        ...
                        <div class="form-wrapper p-4 p-md-5 rounded-4 bg-white shadow-lg">
                            ...
                            <form action="#" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="tex" class="form-control" id="form-nome" required>
                                </div>
                                ...
                                <div class="form-check mb-4">
                                    <input class="form-check-input" type="checkbox" value="" id="politica-privacidade"
                                        required>
                                    <label class="form-check-label small" for="politica-privacidade">
                                        Eu li e aceito a <a href="https://torcisao.com.br/politicadeprivacidade/"
                                            class="politica-link">Política de Privacidade</a> e concordo com o
                                        tratamento dos meus dados para as finalidades descritas.
                                    </label>
                                </div>
                    ...
                    <div class="col-12 col-lg-6 d-flex align-items-center form-destaque-bg order-1 order-lg-0">
                        <div class="p-4 p-md-5 text-center text-white">
                            <h3 class="destaque-text">
                                Se é Torcisão, é garantia de durabilidade, segurança e o melhor custo-benefício do
                                mercado.
                            </h3>
                        </div>
                    </div>
        ...
        <section id="iso-section">
            <a href="https://drive.google.com/file/d/1csvp6XcIvffw2O-F7MXWyL6QPB9ZD-St/view?usp=drive_link"
                class="iso-banner-wrapper" target="_blank" title="Clique para visualizar o Certificado ISO 9001:2015">
                <p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4 mb-5 mb-md-0">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="politicadequalidade.html">Política de Qualidade</a></li>
                        ...
                        <div class="col-12 col-md-4 mb-5 mb-md-0">
                            ...
                            <p class="d-flex flex-column mb-4">
                                <a class="contato-link d-flex align-items-center" href="mailto:vendas@torcisao.com.br">
                                    <img src="assets/email.png" alt="Email" class="footer-icon me-2"
                                        style="width: 20px;">
                                    vendas@torcisao.com.br
                                </a>
                                <a class="contato-link d-flex align-items-center mt-2" href="tel:+551123349989">
                                    <img src="assets/telefone.png" alt="Telefone" class="footer-icon me-2"
                                        style="width: 20px;">
                                    (11) 2334-9989
                                </a>
                            </p>
                            ...
                            <address class="mb-0" style="font-style: normal;">
                                <a href="https://www.google.com/maps/search/?api=1&query=Rua+Francisco+Pedroso+de                    +Toledo,+138,+Vila+Livieiro,+São+Paulo/SP,+04185-150"
                                    target="_blank" class="contato-link" style="display: block; text-decoration: none;">
