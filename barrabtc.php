...
<head>
    ...
    <title>Barras - Baixo Teor de Carbono</title>
        ...
        <div id="carousel-barrabtc" class="carousel slide product-carousel mb-3" data-bs-ride="carousel" data-bs-interval="3000">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="assets/barra4.jpg" class="d-block w-100" alt="Barras Trefiladas - Imagem 1">
                </div>
                <div class="carousel-item">
                    <img src="assets/barra3.jpg" class="d-block w-100" alt="Barras Trefiladas - Imagem 2">
                </div>
                <div class="carousel-item">
                    <img src="assets/barra2.webp" class="d-block w-100" alt="Barras Trefiladas - Imagem 3">
                </div>
                <div class="carousel-item">
                    <img src="assets/barra1.jpg" class="d-block w-100" alt="Barras Trefiladas - Imagem 4">
                </div>
            </div>
